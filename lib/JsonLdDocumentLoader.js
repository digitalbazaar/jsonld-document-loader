...
export class JsonLdDocumentLoader {
  ...
  /**
   * Clones this document loader, allowing the clone to be additionally
   * configured in some way that is different from the original.
   *
   * @returns {object} - The cloned `JsonLdDocumentLoader` instance.
   */
  clone() {
